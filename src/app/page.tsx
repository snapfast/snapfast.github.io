  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.description}>
        ...
        <a href="https://github.com/snapfast" aria-label="Github" target="_blank" rel="noopener">
          <svg width="72" height="72" viewBox="0 0 110 110" xmlns="http://www.w3.org/2000/svg">
